...
@section('content')
    ...
    <div
        ...
        data-endpoints='@json(['toggle' => route('pump.toggle'), 'state' => route('pump.state')])'
        ...
        <header class="mb-10 flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div class="space-y-3">
                ...
                <p class="max-w-xl text-sm text-white/70">
                    Monitoriza en tiempo real el estado de la bomba de fluidos, administra la energía disponible y
                    verifica la telemetría simulada mientras el hardware ESP32 se integra en la siguiente fase.
                </p>
            </div>
            ...
            <div class="flex flex-wrap items-center gap-3 self-start lg:self-auto">
                ...
                <span class="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-xs font-medium text-white/70">
                    Versión demo conectada a ESP32 (simulada)
                </span>
